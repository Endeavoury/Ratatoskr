...
- Artifact workspace: `.agentic/workflows/<work-id>/agents/protocol-modeler/<assignment-id>/`.
- Workspace outputs: `protocol-model.yaml`, modeling decisions, assigned independent reviews.
...
Allowed, only within the delegation's concrete paths: Assigned workspace protocol-model.yaml and model decision/handoff/completion records.
