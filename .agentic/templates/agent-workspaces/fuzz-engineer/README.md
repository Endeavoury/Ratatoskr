# fuzz-engineer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/fuzz-engineer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/fuzz-engineer/SKILL.md` and
`docs/agentic/DIRECTORIES.md` from the repository root before work.

Workspace outputs: `fuzz-plan.md`, `fuzz-results.md`.

Eligible shared paths, requiring explicit assignment: `fuzz/<component>/`, derived corpus and scoped fuzz CMake registration.
