# compatibility-reviewer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/compatibility-reviewer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/compatibility-reviewer/SKILL.md` and
`docs/agentic/DIRECTORIES.md` from the repository root before work.

Workspace outputs: `compatibility-report.md`, G12 record.

Eligible shared paths, requiring explicit assignment: None; ABI, source and documentation are read-only.
