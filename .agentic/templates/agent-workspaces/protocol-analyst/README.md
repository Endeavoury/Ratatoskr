# protocol-analyst workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/protocol-analyst/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/protocol-analyst/SKILL.md` and
