# protocol-api-designer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/protocol-api-designer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/protocol-api-designer/SKILL.md` and
...
Eligible shared paths, requiring explicit assignment: None; public headers are read-only design inputs.
