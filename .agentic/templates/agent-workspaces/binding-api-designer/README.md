# binding-api-designer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/binding-api-designer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/binding-api-designer/SKILL.md` and
...
Eligible shared paths, requiring explicit assignment: None; `bindings/<language>/` and public headers are read-only design inputs.
