# security-reviewer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/security-reviewer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/security-reviewer/SKILL.md` and
`docs/agentic/DIRECTORIES.md` from the repository root before work.

Workspace outputs: `security-review.md`, G8/G9 records.

Eligible shared paths, requiring explicit assignment: None; implementation and fuzz evidence are read-only.
