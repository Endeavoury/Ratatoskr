# final-reviewer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/final-reviewer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/final-reviewer/SKILL.md` and
`docs/agentic/DIRECTORIES.md` from the repository root before work.

Workspace outputs: `final-review.md`, G14 record.

Eligible shared paths, requiring explicit assignment: None; all reviewed artifacts and shared state are read-only.
