# binding-implementer workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/binding-implementer/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/binding-implementer/SKILL.md` and
`docs/agentic/DIRECTORIES.md` from the repository root before work.

Workspace outputs: `binding-report.md`.

Eligible shared paths, requiring explicit assignment: `bindings/<language>/` including local tests, examples and packaging; explicitly assigned binding CI files.
