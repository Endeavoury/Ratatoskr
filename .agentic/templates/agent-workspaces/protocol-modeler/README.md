# protocol-modeler workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/protocol-modeler/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/protocol-modeler/SKILL.md` and
...
Eligible shared paths, requiring explicit assignment: None.
