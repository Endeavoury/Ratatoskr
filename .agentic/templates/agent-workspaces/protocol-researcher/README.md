# protocol-researcher workspace template

Template only; this directory is not an active assignment or approved artifact.

Copy this directory to
`.agentic/workflows/<work-id>/agents/protocol-researcher/<assignment-id>/`.
...
Read `AGENTS.md`, `.hermes/skills/protocol-researcher/SKILL.md` and
...
Eligible shared paths, requiring explicit assignment: None; source and code discovery is read-only.
